...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/diagrams/垂直.pdf}
        \caption{$\vec{E}$垂直于入射面的分量}
        \label{pic:ve}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/diagrams/平行.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/diagrams/实验装置.pdf}
    \caption{实验装置示意图}
    \label{equip}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\textwidth]{figures/plots/Code_Generated_Image.png}
    \caption{光电流和光强的关系}
\end{figure}
