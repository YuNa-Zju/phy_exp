\documentclass[yuxi]{../../templates/Report}%方括号内写yuxi即生成预习报告\documentclass[yuxi]{../../templates/Report}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.5\textwidth]{figures/diagrams/v02-实验原理.pdf}
    \caption{密立根油滴实验原理}
\end{figure}
\begin{enumerate}
    \item \textbf{静态平衡法}
