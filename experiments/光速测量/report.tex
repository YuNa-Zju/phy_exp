...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/diagrams/理论原理图.png}
    \caption{相位法测量光速原理}
    \label{fig:相位法原理}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/diagrams/真实仪器示意图.png}
    \caption{真实仪器示意图}
    \label{fig:真实仪器示意图}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/diagrams/仪器原理.png}
    \caption{仪器原理}
    \label{fig:仪器原理}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/photos/实验数据原图.jpg}
    \caption{实验数据原图}
    \label{fig:原始数据1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/plots/线性拟合图.png}
    \caption{线性拟合图}
    \label{fig:线性拟合图}
\end{figure}
