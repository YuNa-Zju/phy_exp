...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/diagrams/拉脱法_实验原理示意图.png}
    \caption{拉脱法实验原理示意图}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/diagrams/拉脱法_实验原理.png}
    \caption{拉脱法实验原理}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/diagrams/拉脱法_实验原理2.png}
    \caption{拉脱法实验原理}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/diagrams/思考题2分析示意图.JPG}
    \caption{思考题2分析示意图}
\end{figure}
