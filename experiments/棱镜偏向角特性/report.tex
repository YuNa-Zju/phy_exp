...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/diagrams/实验步骤.png}
    \caption{实验步骤}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/diagrams/实验原理.png}
    \caption{实验原理}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/plots/数据拟合.png}
