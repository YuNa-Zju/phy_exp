...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/diagrams/guangdian.png}
    \caption{实验原理图}
    \label{guangdian}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/plots/fit1.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/fuangraph1.png}
        \caption{$\phi=\SI{8}{mm},\lambda = \SI{365}{nm},L = \SI{380}{mm}$时的伏安曲线}
        \label{fuangraph1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/fuangraph2.png}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/guangqiangphigraph.png}
        \caption{$\lambda = \SI{365}{nm}$、$U_{AK} = \SI{30.00}{V}$、$L = \SI{300}{mm}$时不同光阑孔径$\phi$时的$I_H \sim \phi^2$图线}
        \label{guangqiangphigraph}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/guangqiangLgraph.png}
