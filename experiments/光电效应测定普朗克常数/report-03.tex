...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{figures/diagrams/guangdian.pdf}
    \caption{实验原理图}
    \label{guangdian}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/plots/Ua.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/8_365_380.png}
        \caption{$\phi=\SI{8}{mm},\lambda = \SI{365}{nm},L = \SI{380}{mm}$时的伏安曲线}
        \label{fuangraph1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/4_577_400.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/res2.png}
