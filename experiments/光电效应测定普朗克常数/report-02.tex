...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.32\textwidth]{figures/diagrams/guangdian.png}
    \caption{实验原理图}
    \label{guangdian}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}cc@{}}
        \begin{minipage}[t]{0.27\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/diagrams/频率-电压.png}\\[4pt]
            \footnotesize 截止电压与频率的关系示意图
        \end{minipage}
        &
        \begin{minipage}[t]{0.42\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/diagrams/电压-电流.png}\\[4pt]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/photos/pic1.jpg}
    \caption{实验原始数据记录照片 1}
    \label{fig:data_photoelectric_1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/photos/pic2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.53\textwidth]{figures/plots/Ua_invLambda_fit.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.75\textwidth]{figures/plots/IU_curve.png}
        \caption{伏安特性曲线}
        \label{fig:IU_curve}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/plots/Is_vs_phi2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/plots/Is_vs_L2.png}
