...
\begin{figure}[H]
    \centering
    \includegraphics[width=.5\textwidth]{figures/diagrams/夫.pdf}
    \caption{夫琅禾费衍射}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.3\textwidth]{figures/diagrams/光栅.pdf}
    \caption{光栅衍射法测光的波长}
\end{figure}
\subsubsection{实验方法}
\begin{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{figures/plots/intensity.pdf}
    \caption{单缝衍射中光强分布图像}
    \label{fig:intensity}
\end{figure}
因为光强符合
...
\includepdf[pages=1]{figures/plots/fit.pdf}
\end{fullreportonly}
\end{document}
