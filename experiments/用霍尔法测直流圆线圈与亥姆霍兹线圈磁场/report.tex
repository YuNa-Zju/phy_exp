...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figures/diagrams/xianquan.png}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{figures/diagrams/huoerxiaoying.png}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figures/photos/huoerfa.jpg}
        \caption{原始数据}
    \end{center}
\end{figure}
\section{结果与分析（60分）}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figures/plots/dxqquxian.png}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figures/plots/sxqqx.png}
