...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/diagrams/实验原理_驻波.png}
    \caption{驻波形成示意图}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/diagrams/一维振动不同时刻状态.png}
    \caption{一维振动不同时刻状态}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/diagrams/波动方程推导.png}
    \caption{一维波动方程推导}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/plots/实验二数据拟合.png}
    \caption{实验二数据拟合图象}
\end{figure}
