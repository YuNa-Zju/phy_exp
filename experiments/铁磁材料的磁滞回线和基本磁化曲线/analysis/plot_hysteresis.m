...
%% 保存图片
plotDir = fullfile(fileparts(fileparts(mfilename('fullpath'))), 'figures', 'plots');
if ~exist(plotDir, 'dir'), mkdir(plotDir); end
print(figure(1), fullfile(plotDir, '基本磁化曲线.png'), '-dpng', '-r300');
print(figure(2), fullfile(plotDir, '磁滞回线.png'), '-dpng', '-r300');
print(figure(3), fullfile(plotDir, '双Y轴磁化曲线.png'), '-dpng', '-r300');
print(figure(4), fullfile(plotDir, '相对磁导率曲线.png'), '-dpng', '-r300');
...
print(figure(5), fullfile(plotDir, '磁导率曲线.png'), '-dpng', '-r300');
...
print(figure(6), fullfile(plotDir, '磁滞回线面积.png'), '-dpng', '-r300');
