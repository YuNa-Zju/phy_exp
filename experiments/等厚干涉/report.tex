...
\begin{figure}[H]
  ...
  \begin{minipage}{0.45\textwidth}
    \centering
  \includegraphics[width=0.8\textwidth]{figures/diagrams/仪器示意图.png}
  \caption{牛顿环原理示意图}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
    \centering
  \includegraphics[width=\textwidth]{figures/diagrams/条纹示意图.png}
  \caption{劈尖干涉原理示意图}
  \end{minipage}
\end{figure}
\subsubsection{实验仪器}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/photos/Y原始数据.jpg}
  \caption{实验原始数据记录示例}
\end{figure}
\newpage
\section{结果与分析（60分）}
