...
\begin{figure}[H]
    ...
    \includegraphics[width=0.4\textwidth]{figures/diagrams/光栅原理.png}
    \caption{光栅衍射原理示意图}
    \label{fig:principle}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        % 设置固定高度以保证并排对齐
        \includegraphics[height=3.7cm]{figures/diagrams/分光计载物台.png}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[height=3.7cm]{figures/diagrams/载物台示意图.png}
        \caption{透射光栅摆放位置示意图}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/photos/实验数据.jpg}
  \caption{实验数据照片}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/diagrams/斜入射.jpg}
    \caption{平行光斜入射光栅示意图}
