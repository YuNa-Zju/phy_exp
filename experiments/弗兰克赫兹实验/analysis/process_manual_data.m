...
saveas(gcf, fullfile(plotDir, 'manual_curve.png'));
...
% 保存拟合图
saveas(gcf, fullfile(plotDir, 'manual_fit.png'));
fprintf('图片已保存至 figures/plots/manual_curve.png 和 figures/plots/manual_fit.png\n');
