...
| 报告 | 原路径 |
| --- | --- |
| [report.tex](report.tex) | `分光计的调整和使用/分光计的调整和使用.tex` |
| [report-02.tex](report-02.tex) | `分光计的调整和使用/分光计的调整和使用2.tex` |
...
```bash
python3 scripts/build_reports.py "experiments/分光计的调整和使用/report.tex"
```
