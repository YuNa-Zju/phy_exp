...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/diagrams/电阻误差.png}
    \caption{电阻误差}
    \label{fig:wh}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/diagrams/四端子.png}
    \caption{四端子连接示意图}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/diagrams/直流双臂电桥.png}
    \caption{双臂电桥测低电阻电路图}
    \label{fig:kelvin}
\end{figure}
如图所示，双臂电桥的关键结构包括：
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/plots/alpha_fit.png}
    \caption{电阻—温度线性拟合图}
