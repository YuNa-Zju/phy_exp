\documentclass[]{../../templates/Report}%方括号内写yuxi即生成预习报告
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{figures/diagrams/交流负载电路.jpg}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}[t]{0.45\linewidth}
            \centering
            \includegraphics[width=0.8\textwidth]{figures/diagrams/半波整流电路.jpg}
            \caption{单相半波整流电路}
            \label{fig:1}
        \end{minipage}
        \begin{minipage}[t]{0.45\linewidth}
            \centering
            \includegraphics[width=0.8\textwidth]{figures/diagrams/全波整流电路.jpg}
            \caption{单相全波整流电路}
            \label{fig:2}
        \end{minipage}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{figures/diagrams/桥式整流电路.jpg}
        \caption{桥式整流电路}
        \label{fig:3}
    \end{figure}
    \item 滤波原理：
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{figures/diagrams/RC滤波电路.jpg}
        \caption{含不同负载及补偿电容的交流电路模型}
        \label{fig:filter}
    \end{figure}
\end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/photos/原始数据.jpg}
    \caption{原始数据记录}
    \label{fig:原始数据}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/half_u2.jpg}
        \caption{输入信号 $U_2$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/half_u0.jpg}
        \caption{输出信号 $U_0$}
    \end{subfigure}
    \vspace{0.2cm}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/half_diode_fwd.jpg}
        \caption{二极管正向电压}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/half_diode_rev.jpg}
        \caption{二极管反向电压}
    \end{subfigure}
    \caption{单相半波整流电路波形}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/full_u2.jpg}
        \caption{输入信号 $U_2$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/full_u0.jpg}
        \caption{输出信号 $U_0$}
    \end{subfigure}
    \vspace{0.2cm}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/full_diode_fwd.jpg}
        \caption{二极管正向电压}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/full_diode_rev.jpg}
        \caption{二极管反向电压}
    \end{subfigure}
    \caption{单相全波整流电路波形}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/bridge_u2.jpg}
        \caption{输入信号 $U_2$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/bridge_u0.jpg}
        \caption{输出信号 $U_0$}
    \end{subfigure}
    \vspace{0.2cm}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/bridge_diode_fwd.jpg}
        \caption{二极管正向电压}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/bridge_diode_rev.jpg}
        \caption{二极管反向电压}
    \end{subfigure}
    \caption{桥式整流电路波形}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/0.47.jpg}
        \caption{C=0.47uF}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/47.jpg}
        \caption{C=47uF}
    \end{subfigure}
    \vspace{0.2cm}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/470.jpg}
        \caption{C=470uF}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth, height=3.5cm, keepaspectratio]{figures/photos/1000.jpg}
        \caption{C=1000uF}
    \end{subfigure}
