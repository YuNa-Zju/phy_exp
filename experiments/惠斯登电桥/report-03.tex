...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/diagrams/自绘电桥.png}
        \caption{惠斯登电桥示意图}
        \label{fig:a}
    \end{subfigure}
    \begin{subfigure}[b]{0.415\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/diagrams/交换法.png}
        \caption{交换法测量示意图}
        \label{fig:b}
    \end{subfigure}
    \caption{惠斯登电桥相关示意图}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/photos/原始数据.jpg}
    \caption{原始数据记录}
    \label{fig:fig2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/plots/电阻测量值.png}
    \caption{电阻测量值分布图}
