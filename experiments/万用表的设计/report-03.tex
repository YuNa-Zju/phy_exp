...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=\textwidth]{figures/diagrams/tidaifa.png}
        \caption{内阻测定}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.23\textwidth}
    ...
    \hfill
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=\textwidth]{figures/diagrams/gaizhuangOhm.png}
        \caption{改欧姆表}
    \end{subfigure}
    \caption{实验原理与改装电路图}
    \label{fig:circuits}
...
\begin{fullreportonly}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[width=\textwidth]{figures/plots/v03-relaA.png}
            \caption{$I_G - I_B$ 校验曲线}
            \label{relaA}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[width=\textwidth]{figures/plots/v03-deltaA.png}
    ...
    \begin{figure}[H]
        \centering
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[width=\textwidth]{figures/plots/v03-relaV.png}
            \caption{$V_G - V_B$ 校验曲线}
            \label{relaV}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[width=\textwidth]{figures/plots/v03-deltaV.png}
    ...
    \begin{figure}[H]
        \centering
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[width=\textwidth]{figures/plots/v03-graphOhm.png}
            \caption{$I_x - R_x$ 反比例拟合}
            \label{graphOhm}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.48\textwidth}
            \includegraphics[width=\textwidth]{figures/plots/v03-ohm_linear.png}
