\documentclass[]{../../templates/Report}
\settemplatedir{../../templates/} %设置模板文件夹路径
\exname{万用表的设计} %实验名称
\extable{}
\instructor{} %指导教师
\class{} %班级
...
\subsubsection{测量电流计的内阻}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.4\textwidth]{figures/diagrams/tidaifa.png}
        \caption{替代法测量电流计内阻}
        \label{tidaifa}
    \end{figure}
...
\subsubsection{改装欧姆表}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.4\textwidth]{figures/diagrams/gaizhuangOhm.png}
        \caption{欧姆表设计电路}
        \label{gaizhuangOhm}
    \end{figure}
\subsection{实验重点}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/relaA.png}
        \caption{改装$\SI{5}{\milli A}$电流表的$I_G \sim I_B$曲线}
        \label{graphA}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/deltaA.png}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/relaV.png}
        \caption{改装$\SI{5}{V}$电流表的$V_G \sim V_B$曲线}
        \label{relaV}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/plots/deltaV.png}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.4\textwidth]{figures/plots/graphOhm.png}
