...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/1-1.jpg}
        \caption{1个完整波形}
        \label{pic:1:1}
    \end{subfigure}
    \hfill % 在子图之间添加水平间距
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/1-2.jpg}
        \caption{2个完整波形}
        \label{pic:1:2}
    \end{subfigure}
    \hfill % 在子图之间添加水平间距
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/1-3.jpg} % <-- 替换为您的图片
        \caption{3个完整波形}
        \label{pic:1:3}
    \end{subfigure}
    ...
    % --- 第二行 ---
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/1-4.jpg} % <-- 替换为您的图片
        \caption{4个完整波形}
        \label{pic:2:1}
    \end{subfigure}
    \hfill % 在子图之间添加水平间距
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/1-5.jpg} % <-- 替换为您的图片
        \caption{5个完整波形}
        \label{pic:2:3}
    \end{subfigure}
    \hfill % 在子图之间添加水平间距
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/1-6.jpg} % <-- 替换为您的图片
        \caption{6个完整波形}
        \label{pic:3:2}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    % --- 第一行 ---
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/2-1.jpg}
        \caption{1:1}
        \label{pic:1:1}
    \end{subfigure}
    \hfill % 在子图之间添加水平间距
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/2-2.jpg}
        \caption{1:2}
        \label{pic:1:2}
    \end{subfigure}
    \hfill % 在子图之间添加水平间距
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/2-3.jpg} % <-- 替换为您的图片
        \caption{1:3}
        \label{pic:1:3}
    \end{subfigure}
    ...
    % --- 第二行 ---
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/2-4.jpg} % <-- 替换为您的图片
        \caption{2:1}
        \label{pic:2:1}
    \end{subfigure}
    \hfill % 在子图之间添加水平间距
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/2-5.jpg} % <-- 替换为您的图片
        \caption{2:3}
        \label{pic:2:3}
    \end{subfigure}
    \hfill % 在子图之间添加水平间距
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/2-6.jpg} % <-- 替换为您的图片
        \caption{3:2}
        \label{pic:3:2}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/3-1.jpg}
        \caption{输入电压的峰-峰值}
        \label{pic:pp}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/3-2.jpg}
        \caption{半波电压的峰值}
        \label{pic:p}
    \end{subfigure}
\caption{测量二极管正向导通电压}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/4-1.jpg}
        \caption{输入信号的周期}
        \label{pic:T}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{figures/photos/4-2.jpg}
        \caption{两峰之间的相位差}
        \label{pic:phi}
    \end{subfigure}
\caption{测量RC电路相位差}
